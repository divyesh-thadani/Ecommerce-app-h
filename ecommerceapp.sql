...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2282128320ltr&server=1">
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="427d2b6d305c34617949452c3b3c3c28">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="ecommerceapp" targettable="orders">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `orders`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="ecommerceapp" targettable="products">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `products`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="ecommerceapp" targettable="notifications">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `notifications`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="ecommerceapp" targettable="cart">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `cart`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="ecommerceapp" targettable="user_info">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `orders`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="ecommerceapp" targettable="admin">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `admin`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="ecommerceapp" targettable="brands">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `notifications` (`id`, `notification`, `is_active`) VALUES (NULL, &#039;User Registered&#039;, &#039;0&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ecommerceapp" targettable="notifications">
                            <div class="action_content">
